"""autogenerated by genmsg_py from PlateStageConversionRequest.msg. Do not edit."""
import roslib.message
import struct


class PlateStageConversionRequest(roslib.message.Message):
  _md5sum = "dadc981f505ddea0841a3922fdd33de4"
  _type = "plate_tf/PlateStageConversionRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlateStageConversionRequest, self).__init__(*args, **kwds)
...
"""autogenerated by genmsg_py from PlateStageConversionResponse.msg. Do not edit."""
import roslib.message
import struct


class PlateStageConversionResponse(roslib.message.Message):
  _md5sum = "12668e153c72024ad4d14819f42324b1"
  _type = "plate_tf/PlateStageConversionResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlateStageConversionResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
_struct_I = roslib.message.struct_I
class PlateStageConversion(roslib.message.ServiceDefinition):
  _type          = 'plate_tf/PlateStageConversion'
  _md5sum = '73706dcabefa494de10216f0b3e1c890'
  _request_class  = PlateStageConversionRequest
  _response_class = PlateStageConversionResponse
