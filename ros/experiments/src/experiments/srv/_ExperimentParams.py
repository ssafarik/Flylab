...
class ExperimentParamsRequest(roslib.message.Message):
  _md5sum = "df5f51a0f1107bf71a39897277548aa5"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_di2dB6d.pack(_x.move.pattern.hz, _x.move.pattern.count, _x.move.pattern.radius, _x.move.timeout, _x.triggerExit.enabled, _x.triggerExit.distanceMin, _x.triggerExit.distanceMax, _x.triggerExit.speedMin, _x.triggerExit.speedMax, _x.triggerExit.angleMin, _x.triggerExit.angleMax))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.move.pattern.hz, _x.move.pattern.count, _x.move.pattern.radius, _x.move.timeout, _x.triggerExit.enabled, _x.triggerExit.distanceMin, _x.triggerExit.distanceMax, _x.triggerExit.speedMin, _x.triggerExit.speedMax, _x.triggerExit.angleMin, _x.triggerExit.angleMax,) = _struct_di2dB6d.unpack(str[start:end])
...
_struct_di2dB6d = struct.Struct("<di2dB6d")
...
class ExperimentParams(roslib.message.ServiceDefinition):
  ...
  _md5sum = '5808c8ba5652d03d7168883a279eaa4a'
