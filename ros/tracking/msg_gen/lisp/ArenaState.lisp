...
(cl:defmethod cl:initialize-instance :after ((m <ArenaState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ArenaState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tracking-msg:<ArenaState> is deprecated: use tracking-msg:ArenaState instead.")))

(cl:ensure-generic-function 'robot-val :lambda-list '(m))
(cl:defmethod robot-val ((m <ArenaState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tracking-msg:robot-val is deprecated.  Use tracking-msg:robot instead.")
  (robot m))

(cl:ensure-generic-function 'flies-val :lambda-list '(m))
(cl:defmethod flies-val ((m <ArenaState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tracking-msg:flies-val is deprecated.  Use tracking-msg:flies instead.")
  (flies m))
