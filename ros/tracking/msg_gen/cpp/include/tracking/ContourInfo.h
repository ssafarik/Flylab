/* Auto-generated by genmsg_cpp for file /home/ssafarik/git/Flyatar2/ros/tracking/msg/ContourInfo.msg */
#ifndef TRACKING_MESSAGE_CONTOURINFO_H
#define TRACKING_MESSAGE_CONTOURINFO_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
private:
  static const char* __s_getDataType_() { return "tracking/ContourInfo"; }
public:
...
public:
  ...
  typedef boost::shared_ptr< ::tracking::ContourInfo_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::tracking::ContourInfo_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct ContourInfo
typedef  ::tracking::ContourInfo_<std::allocator<void> > ContourInfo;

typedef boost::shared_ptr< ::tracking::ContourInfo> ContourInfoPtr;
typedef boost::shared_ptr< ::tracking::ContourInfo const> ContourInfoConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::tracking::ContourInfo_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::tracking::ContourInfo_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::tracking::ContourInfo_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::tracking::ContourInfo_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::tracking::ContourInfo_<ContainerAllocator> > {
  static const char* value() 
  {
    return "c8fd16a1f087957d23963303f01c039b";
  }

  static const char* value(const  ::tracking::ContourInfo_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0xc8fd16a1f087957dULL;
  static const uint64_t static_value2 = 0x23963303f01c039bULL;
};

template<class ContainerAllocator>
struct DataType< ::tracking::ContourInfo_<ContainerAllocator> > {
  static const char* value() 
  {
    return "tracking/ContourInfo";
  }
...
template<class ContainerAllocator>
struct Definition< ::tracking::ContourInfo_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct HasHeader< ::tracking::ContourInfo_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::tracking::ContourInfo_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::tracking::ContourInfo_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::tracking::ContourInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::tracking::ContourInfo_<ContainerAllocator> & v) 
  {
    s << indent << "header: ";
s << std::endl;
...
#endif // TRACKING_MESSAGE_CONTOURINFO_H
