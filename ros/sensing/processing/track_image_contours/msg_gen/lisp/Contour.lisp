...
(cl:defmethod cl:initialize-instance :after ((m <Contour>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Contour)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name track_image_contours-msg:<Contour> is deprecated: use track_image_contours-msg:Contour instead.")))
...
(cl:defmethod angle-val ((m <Contour>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader track_image_contours-msg:angle-val is deprecated.  Use track_image_contours-msg:angle instead.")
  (angle m))
