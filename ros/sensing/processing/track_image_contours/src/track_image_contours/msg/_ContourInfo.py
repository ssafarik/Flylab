"""autogenerated by genmsg_py from ContourInfo.msg. Do not edit."""
...
class ContourInfo(roslib.message.Message):
  ...
  _type = "track_image_contours/ContourInfo"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ContourInfo, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.ecc))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.ecc = struct.unpack(pattern, str[start:end])
      return self
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.ecc = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      return self
    except struct.error as e:
      raise roslib.message.DeserializationError(e) #most likely buffer underfill
