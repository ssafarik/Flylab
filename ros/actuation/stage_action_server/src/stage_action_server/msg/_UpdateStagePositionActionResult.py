"""autogenerated by genmsg_py from UpdateStagePositionActionResult.msg. Do not edit."""
...
class UpdateStagePositionActionResult(roslib.message.Message):
  _md5sum = "ee80e7f11b0187a593a82c71a26a225f"
  _type = "stage_action_server/UpdateStagePositionActionResult"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','stage_action_server/UpdateStagePositionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(UpdateStagePositionActionResult, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.pose.position.x, _x.result.pose.position.y, _x.result.pose.position.z, _x.result.pose.orientation.x, _x.result.pose.orientation.y, _x.result.pose.orientation.z, _x.result.pose.orientation.w, _x.result.velocity.linear.x, _x.result.velocity.linear.y, _x.result.velocity.linear.z, _x.result.velocity.angular.x, _x.result.velocity.angular.y, _x.result.velocity.angular.z,) = _struct_13d.unpack(str[start:end])
      return self
