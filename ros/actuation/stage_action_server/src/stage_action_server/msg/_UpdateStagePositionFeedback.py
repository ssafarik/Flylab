"""autogenerated by genmsg_py from UpdateStagePositionFeedback.msg. Do not edit."""
...
class UpdateStagePositionFeedback(roslib.message.Message):
  _md5sum = "b3dff8faff5245565795cc8a6e908f1f"
  _type = "stage_action_server/UpdateStagePositionFeedback"
...
"""
  ...
  _slot_types = ['Header','geometry_msgs/Pose','geometry_msgs/Twist']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(UpdateStagePositionFeedback, self).__init__(*args, **kwds)
