"""autogenerated by genmsg_py from ActionStageStateResult.msg. Do not edit."""
...
class ActionStageStateResult(roslib.message.Message):
  _md5sum = "1977707d7eabf7e0ca765b9e57161cd5"
  _type = "stage_action_server/ActionStageStateResult"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ActionStageStateResult, self).__init__(*args, **kwds)
