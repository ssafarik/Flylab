"""autogenerated by genmsg_py from ActionStageStateGoal.msg. Do not edit."""
...
class ActionStageStateGoal(roslib.message.Message):
  _md5sum = "1977707d7eabf7e0ca765b9e57161cd5"
  _type = "stage_action_server/ActionStageStateGoal"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ActionStageStateGoal, self).__init__(*args, **kwds)
