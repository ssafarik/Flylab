"""autogenerated by genmsg_py from SrvStageStateRequest.msg. Do not edit."""
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SrvStageStateRequest, self).__init__(*args, **kwds)
...
"""autogenerated by genmsg_py from SrvStageStateResponse.msg. Do not edit."""
import roslib.message
import struct
...
class SrvStageStateResponse(roslib.message.Message):
  _md5sum = "1977707d7eabf7e0ca765b9e57161cd5"
  _type = "flystage/SrvStageStateResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """MsgFrameState state
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SrvStageStateResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.state is None:
        self.state = flystage.msg.MsgFrameState()
    else:
