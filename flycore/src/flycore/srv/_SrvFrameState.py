"""autogenerated by genmsg_py from SrvFrameStateRequest.msg. Do not edit."""
...
class SrvFrameStateRequest(roslib.message.Message):
...
"""autogenerated by genmsg_py from SrvFrameStateResponse.msg. Do not edit."""
import roslib.message
import struct
...
class SrvFrameStateResponse(roslib.message.Message):
...
class SrvFrameState(roslib.message.ServiceDefinition):
