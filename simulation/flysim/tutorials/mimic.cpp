...
Mimic::Mimic()
{
  ...
  vel_pub_ = output_nh.advertise<flysim::Velocity>("command_velocity", 1);
  pose_sub_ = input_nh.subscribe<flysim::Pose>("pose", 1, &Mimic::poseCallback, this);
}

void Mimic::poseCallback(const flysim::PoseConstPtr& pose)
{
  flysim::Velocity vel;
