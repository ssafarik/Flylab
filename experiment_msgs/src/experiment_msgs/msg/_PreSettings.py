"""autogenerated by genpy from experiment_msgs/PreSettings.msg. Do not edit."""
import sys
...
class PreSettings(genpy.Message):
  _md5sum = "872d66b0fdb4108cd0496edd85828810"
  _type = "experiment_msgs/PreSettings"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# (waitEntry1->triggerEntry->waitEntry2) runs concurrently with (robot) and (lasergalvos) and (ledpanels).  Any terminate -> all terminate.
float64 			       wait1
...
"""
  __slots__ = ['wait1','trigger','wait2','robot','lasergalvos','ledpanels']
  _slot_types = ['float64','experiment_msgs/TriggerSettings','float64','experiment_msgs/RobotSettings','experiment_msgs/LasergalvosSettings','experiment_msgs/LEDPanelsSettings']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       wait1,trigger,wait2,robot,lasergalvos,ledpanels
    ...
    """
    if args or kwds:
      super(PreSettings, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.wait1 is None:
        self.wait1 = 0.
      if self.trigger is None:
        self.trigger = experiment_msgs.msg.TriggerSettings()
      if self.wait2 is None:
        self.wait2 = 0.
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_dB.pack(_x.wait1, _x.trigger.enabled))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B3dB.pack(_x.trigger.angleTestBilateral, _x.trigger.timeHold, _x.trigger.timeout, _x.wait2, _x.robot.enabled))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_d.pack(self.robot.move.relative.distance))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d.pack(_x.robot.move.relative.angleOffset, _x.robot.move.relative.angleOscMag, _x.robot.move.relative.angleOscFreq))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2d.pack(_x.robot.move.relative.speed, _x.robot.move.relative.tolerance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.wait1, _x.trigger.enabled,) = _struct_dB.unpack(str[start:end])
      ...
      (_x.trigger.angleTestBilateral, _x.trigger.timeHold, _x.trigger.timeout, _x.wait2, _x.robot.enabled,) = _struct_B3dB.unpack(str[start:end])
      ...
      (self.robot.move.relative.distance,) = _struct_d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.robot.move.relative.angleOffset, _x.robot.move.relative.angleOscMag, _x.robot.move.relative.angleOscFreq,) = _struct_3d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.robot.move.relative.speed, _x.robot.move.relative.tolerance,) = _struct_2d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
