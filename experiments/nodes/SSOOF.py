...
class ExperimentSSOOF():
    def __init__(self):
        ...
        self.experimentparams.pre.trigger.angleMin = 90.0 * np.pi / 180.0
        self.experimentparams.pre.trigger.angleMax =170.0 * np.pi / 180.0
        ...
        self.experimentparams.trial.robot.move.relative.distance            = [1]  # mm
