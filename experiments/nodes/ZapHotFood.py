...
class Experiment():
    def __init__(self):
        ...
        for iFly in range(self.experimentparams.flyspec.nFlies):#range(3):#
            ...
            self.experimentparams.trial.lasergalvos.statefilterHi_list.append("{'pose':{'position':{'x':-30, 'y':50}}}")  # This is the cool zone.
            self.experimentparams.trial.lasergalvos.statefilterLo_list.append("{'pose':{'position':{'x':-50, 'y':30}}}")
