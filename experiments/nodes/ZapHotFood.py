...
class ExperimentZapHotFood():
    def __init__(self):
        ...
        for iFly in range(rospy.get_param('nFlies', 0)):#range(3):#
            ...
            self.experimentparams.trial.lasertrack.statefilterHi_list.append("{'pose':{'position':{'x':-30, 'y':50}}}")  # This is the cool zone.
            self.experimentparams.trial.lasertrack.statefilterLo_list.append("{'pose':{'position':{'x':-50, 'y':30}}}")
