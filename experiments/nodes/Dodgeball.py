...
class Experiment():
    def __init__(self):
        ...
        self.experimentparams.pre.robot.move.pattern.hzPattern = 1/4               # Patterns per second.
        ...
        self.experimentparams.pre.trigger.timeHold = 0.3                   # How long the conditions must be continually met before the trigger happens.
