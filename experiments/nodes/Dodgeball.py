...
class Experiment():
    def __init__(self):
        ...
        self.experimentparams.pre.trigger.timeHold = 0.5                   # How long the conditions must be continually met before the trigger happens.
        self.experimentparams.pre.trigger.timeout = -1
        self.experimentparams.pre.wait2 = 0.25
        ...
        self.experimentparams.trial.robot.move.timeout = 10                             # When this duration has passed, then the move is over.
