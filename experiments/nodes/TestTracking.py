...
class Experiment():
    def __init__(self):
        ...
        self.experimentparams.experiment.description = 'Test Tracking of Fly Movement'
        ...
        self.experimentparams.trial.robot.move.relative.typeSpeedMax        = ['constant']  # 'constant' or 'random' (random on range [0,speedMax])
