...
(cl:defmethod cl:initialize-instance :after ((m <SaveSettings>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SaveSettings)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name experiments-msg:<SaveSettings> is deprecated: use experiments-msg:SaveSettings instead.")))

(cl:ensure-generic-function 'filenamebase-val :lambda-list '(m))
(cl:defmethod filenamebase-val ((m <SaveSettings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader experiments-msg:filenamebase-val is deprecated.  Use experiments-msg:filenamebase instead.")
  (filenamebase m))

(cl:ensure-generic-function 'arenastate-val :lambda-list '(m))
(cl:defmethod arenastate-val ((m <SaveSettings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader experiments-msg:arenastate-val is deprecated.  Use experiments-msg:arenastate instead.")
  (arenastate m))

(cl:ensure-generic-function 'video-val :lambda-list '(m))
(cl:defmethod video-val ((m <SaveSettings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader experiments-msg:video-val is deprecated.  Use experiments-msg:video instead.")
  (video m))

(cl:ensure-generic-function 'bag-val :lambda-list '(m))
(cl:defmethod bag-val ((m <SaveSettings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader experiments-msg:bag-val is deprecated.  Use experiments-msg:bag instead.")
  (bag m))

(cl:ensure-generic-function 'onlyWhileTriggered-val :lambda-list '(m))
(cl:defmethod onlyWhileTriggered-val ((m <SaveSettings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader experiments-msg:onlyWhileTriggered-val is deprecated.  Use experiments-msg:onlyWhileTriggered instead.")
