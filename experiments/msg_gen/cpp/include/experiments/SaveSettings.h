<<<<<<< HEAD:ros/experiments/msg_gen/cpp/include/experiments/SaveSettings.h
/* Auto-generated by genmsg_cpp for file /home/flybowl/ros_workspace/git/Flyatar2/ros/experiments/msg/SaveSettings.msg */
=======
/* Auto-generated by genmsg_cpp for file /home/ssafarik/git/Flylab/experiments/msg/SaveSettings.msg */
>>>>>>> 9c1a4a3c2e4737d1e04dc78a9ac15ef164e80ec7:experiments/msg_gen/cpp/include/experiments/SaveSettings.h
#ifndef EXPERIMENTS_MESSAGE_SAVESETTINGS_H
#define EXPERIMENTS_MESSAGE_SAVESETTINGS_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
private:
  static const char* __s_getDataType_() { return "experiments/SaveSettings"; }
public:
...
public:
  ...
  typedef boost::shared_ptr< ::experiments::SaveSettings_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::experiments::SaveSettings_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct SaveSettings
typedef  ::experiments::SaveSettings_<std::allocator<void> > SaveSettings;

typedef boost::shared_ptr< ::experiments::SaveSettings> SaveSettingsPtr;
typedef boost::shared_ptr< ::experiments::SaveSettings const> SaveSettingsConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::experiments::SaveSettings_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::experiments::SaveSettings_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::experiments::SaveSettings_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::experiments::SaveSettings_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::experiments::SaveSettings_<ContainerAllocator> > {
  static const char* value() 
  {
    return "8dd39306b182f140b176cdb1eabbcdf0";
  }

  static const char* value(const  ::experiments::SaveSettings_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x8dd39306b182f140ULL;
  static const uint64_t static_value2 = 0xb176cdb1eabbcdf0ULL;
};

template<class ContainerAllocator>
struct DataType< ::experiments::SaveSettings_<ContainerAllocator> > {
  static const char* value() 
  {
    return "experiments/SaveSettings";
  }
...
template<class ContainerAllocator>
struct Definition< ::experiments::SaveSettings_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct Serializer< ::experiments::SaveSettings_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::experiments::SaveSettings_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::experiments::SaveSettings_<ContainerAllocator> & v) 
  {
...
#endif // EXPERIMENTS_MESSAGE_SAVESETTINGS_H
