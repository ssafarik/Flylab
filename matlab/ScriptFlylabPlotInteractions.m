...
nSubsample = 5;     % Only plot every Nth sample.
...
interactions = FlylabGetInteractionsFiles(dirspec, filespec, iFrameParent, iFrameChild, nMinLen, criteria);
