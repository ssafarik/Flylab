...
class ConvertCsv:
    ...
    def SetDefaultHeader(self):
            ...
            self.param_maxTrials                    = ''
            self.param_trial                        = ''
            
            self.param_nRobots                      = '0'
            self.param_widthRobot                   = ''
            self.param_heightRobot                  = ''
            self.param_visibleRobot                 = ''
            self.param_paintRobot                   = ''
            self.param_scentRobot                   = ''
            ...
            self.param_preRobotMovePatternFramePosition= ''
            self.param_preRobotMovePatternFrameAngle   = ''
            self.param_preRobotMovePatternShape        = ''
            self.param_preRobotMovePatternHzPattern    = ''
            self.param_preRobotMovePatternHzPoint      = ''
            self.param_preRobotMovePatternCount        = ''
            self.param_preRobotMovePatternSizeX        = ''
            self.param_preRobotMovePatternSizeY        = ''
            self.param_preRobotMovePatternParam        = ''
            self.param_preRobotMovePatternDirection    = ''
            self.param_preRobotMoveRelTracking         = ''
            self.param_preRobotMoveRelOriginPosition   = ''
            self.param_preRobotMoveRelOriginAngle      = ''
            self.param_preRobotMoveRelDistance         = ''
            self.param_preRobotMoveRelAngle            = ''
            self.param_preRobotMoveRelAngleType        = ''
            self.param_preRobotMoveRelSpeed            = ''
            self.param_preRobotMoveRelSpeedType        = ''
            self.param_preRobotMoveRelTolerance        = ''
    
            self.param_preLaserEnabled                 = 'False'
            self.param_preLaserPatternFramePosition    = ''
            self.param_preLaserPatternFrameAngle       = ''
            self.param_preLaserPatternShape            = ''
            self.param_preLaserPatternHzPattern        = ''
            self.param_preLaserPatternHzPoint          = ''
            self.param_preLaserPatternCount            = ''
            self.param_preLaserPatternSizeX            = ''
            self.param_preLaserPatternSizeY            = ''
            self.param_preLaserPatternParam            = ''
            self.param_preLaserPatternDirection        = ''
            ...
            self.param_preLEDPanelsIdPattern            = ''
            ...
            self.param_preTriggerFrameidParent        = ''
            self.param_preTriggerFrameidChild         = ''
            self.param_preTriggerSpeedAbsParentMin    = ''
            self.param_preTriggerSpeedAbsParentMax    = ''
            self.param_preTriggerSpeedAbsChildMin     = ''
            self.param_preTriggerSpeedAbsChildMax     = ''
            self.param_preTriggerSpeedRelMin          = ''
            self.param_preTriggerSpeedRelMax          = ''
            self.param_preTriggerDistanceMin          = ''
            self.param_preTriggerDistanceMax          = ''
            self.param_preTriggerAngleMin             = ''
            self.param_preTriggerAngleMax             = ''
            self.param_preTriggerAngleTest            = ''
            self.param_preTriggerAngleTestBilateral   = ''
            self.param_preTriggerTimeHold             = ''
            self.param_preTriggerTimeout              = ''

            self.param_preWait2                         = '0.0'

            self.param_trialRobotEnabled                = 'False'
            self.param_trialRobotMovePatternFramePosition= ''
            self.param_trialRobotMovePatternFrameAngle  = ''
            self.param_trialRobotMovePatternShape       = ''
            self.param_trialRobotMovePatternHzPattern   = ''
            self.param_trialRobotMovePatternHzPoint     = ''
            self.param_trialRobotMovePatternCount       = ''
            self.param_trialRobotMovePatternSizeX       = ''
            self.param_trialRobotMovePatternSizeY       = ''
            self.param_trialRobotMovePatternParam       = ''
            self.param_trialRobotMovePatternDirection   = ''
            self.param_trialRobotMoveRelTracking        = ''
            self.param_trialRobotMoveRelOriginPosition  = ''
            self.param_trialRobotMoveRelOriginAngle     = ''
            self.param_trialRobotMoveRelDistance        = ''
            self.param_trialRobotMoveRelAngle           = ''
            self.param_trialRobotMoveRelAngleType       = ''
            self.param_trialRobotMoveRelSpeed           = ''
            self.param_trialRobotMoveRelSpeedType       = ''
            self.param_trialRobotMoveRelTolerance       = ''
    
            self.param_trialLaserEnabled                = 'False'
            self.param_trialLaserPatternFramePosition   = ''
            self.param_trialLaserPatternFrameAngle      = ''
            self.param_trialLaserPatternShape           = ''
            self.param_trialLaserPatternHzPattern       = ''
            self.param_trialLaserPatternHzPoint         = ''
            self.param_trialLaserPatternCount           = ''
            self.param_trialLaserPatternSizeX           = ''
            self.param_trialLaserPatternSizeY           = ''
            self.param_trialLaserPatternParam           = ''
            self.param_trialLaserPatternDirection       = ''
            ...
            self.param_trialLEDPanelsIdPattern          = ''
            ...
            self.param_postTriggerFrameidParent        = ''
            self.param_postTriggerFrameidChild         = ''
            self.param_postTriggerSpeedAbsParentMin    = ''
            self.param_postTriggerSpeedAbsParentMax    = ''
            self.param_postTriggerSpeedAbsChildMin     = ''
            self.param_postTriggerSpeedAbsChildMax     = ''
            self.param_postTriggerSpeedRelMin          = ''
            self.param_postTriggerSpeedRelMax          = ''
            self.param_postTriggerDistanceMin          = ''
            self.param_postTriggerDistanceMax          = ''
            self.param_postTriggerAngleMin             = ''
            self.param_postTriggerAngleMax             = ''
            self.param_postTriggerAngleTest            = ''
            self.param_postTriggerAngleTestBilateral   = ''
            self.param_postTriggerTimeHold             = ''
            self.param_postTriggerTimeout              = ''
    ...
    def ReadHeader_V2 (self, filename):
        ...
        if (versionIn=='2.6') or (versionIn=='2.7'):
            field_list = self.ListFromCsv(headerExperiment)
            self.param_date_time                    = field_list[0]
            self.param_description                  = field_list[1]
            self.param_maxTrials                    = field_list[2]
        ...
        with open(filenameIn, 'r') as fidIn:
            ...
            with open(filenameOut, 'a') as fidOut:
                ...
                for lineIn in fidIn:
                    ...
                    if (versionIn == '2.6'):
                        iFieldIn += 6
                    elif (versionIn == '2.7') or (versionIn == '2.8'):
            ...
            with open(filenameOut, 'a') as fidOut:
                ...
                for lineIn in fidIn:
                    ...
                    if (float(versionIn) < 2.6):
                        ...
                        iFieldIn = 1
                    elif (versionIn == '2.6'):      # Use 'triggered' value from file.
                        lineOutLeft = self.templateStateLeft_V26.format(
                                                            time = fieldsIn_list[0],
                                                            triggered = fieldsIn_list[1],
                                                            )
                        iFieldIn = 2  # Skip the 'triggered' column.
                    elif (versionIn == '2.7'):      # Use 'triggered' value from file.
                    ...
                    elif (versionIn == '2.8'):      # Use 'triggered' value from file.
                        lineOutLeft = self.templateStateLeft_V28.format(
                                                            time = fieldsIn_list[0],
                                                            triggered = fieldsIn_list[1],
                                                            )
                        iFieldIn = 2  # Skip the 'triggered' column.
        ...
        with open(filenameIn, 'r') as fidIn:
            ...
            with open(filenameOut, 'a') as fidOut:
                ...
                for lineIn in fidIn:
                    ...
                    elif (versionIn == '2.7'):      # Use 'wing' values from file.
                        lineOutRobot = self.templateStateRobot_V27.format(
                                                                xRobot          = fieldsIn_list[iFieldIn+0],
                                                                yRobot          = fieldsIn_list[iFieldIn+1],
                                                                aRobot          = fieldsIn_list[iFieldIn+2],
                    ...
                    elif (versionIn == '2.8'):      # Use 'wing' values from file.
                        lineOutRobot = self.templateStateRobot_V28.format(
                                                                xRobot          = fieldsIn_list[iFieldIn+0],
                                                                yRobot          = fieldsIn_list[iFieldIn+1],
                                                                aRobot          = fieldsIn_list[iFieldIn+2],
                                                                vxRobot         = fieldsIn_list[iFieldIn+3],
                    ...
                    for iFly in range(nFlies): 
                        if (float(versionIn) < 2.7):    # Pre-2.7 had no 'wing' columns.  Use default values.
                            ...
                            lineOutFly = self.templateStateFly_V28.format(
                                                                xFly          = fieldsIn_list[iFieldIn+0],
                                                                yFly          = fieldsIn_list[iFieldIn+1],
                                                                aFly          = fieldsIn_list[iFieldIn+2],
                                                                vxFly         = fieldsIn_list[iFieldIn+3],
    ...
    def ConvertDirToDir(self, dirInBase, dirOutBase):
        ...
        if (self.versionToWrite=='2.2') or (self.versionToWrite=='2.6') or (self.versionToWrite=='2.7') or (self.versionToWrite=='2.8') or (self.versionToWrite=='latest'): 
...
if __name__ == '__main__':
    ...
    ###############################################################################################
    ###############################################################################################
    convert.versionToWrite = '2.8'  # '2.2' or '2.6' or '2.7' or 'latest'
